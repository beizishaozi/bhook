...
Java_com_huawei_itrustee_hiaihook_utils_ModelManager_loadModelSync(JNIEnv *env, jclass instance,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_itrustee_hiaihook_utils_ModelManager_unloadModelSync(JNIEnv *env, jclass instance) {
    if (NULL == manager) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_huawei_itrustee_hiaihook_utils_ModelManager_loadModelFromFileSync(JNIEnv *env, jclass type,jstring modelname_,
...
extern "C"
JNIEXPORT jint JNICALL
Java_ccom_huawei_itrustee_hiaihook_utils_ModelManager_loadModelSyncFromBuffer(JNIEnv *env, jclass type,
...
Java_com_huawei_itrustee_hiaihook_utils_ModelManager_runModelSync(JNIEnv *env, jclass type, jobject modelInfo,
                                                             jobjectArray buf_) {
    ...
    for (int i = 0,pos = 0; i < modelTensorinfo->input_cnt; ++i)
    {
        if(NULL !=modelTensorinfo->input_shape)
        {
            ...
            in_h =modelTensorinfo->input_shape[pos++] - 1;
            in_w =modelTensorinfo->input_shape[pos++] - 1;
