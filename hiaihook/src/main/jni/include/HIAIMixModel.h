...
/*-----------------------TensorBuffer--------------------------------------------*/
HIAI_MixModelTensorInfo* HIAI_MixModel_GetModelTensorInfo(HIAI_MixModelManager* manager, const char* modelname);
...
//create buffer for buildmodel,example create  outputmodelbuffer for HIAI_MixModel_BuildModel_ToMem().
HIAI_MixMemBuffer* HIAI_MixMemBuffer_Create(HIAI_Mix_Framework frameworktype,HIAI_MixMemBuffer* inputmodelbuffers[],const unsigned int inputmodelbuffersnum);
